...
export default function About() {
    ...
    <div className={styles.container}>
      ...
      <div className={styles.cardsContainer}>
        ...
        <div className={styles.card}>
          ...
          <p>大阪大学 工学部・工学研究科修了後、米国ロチェスター大学にて博士号取得。
            ...
            材料科学与工程学院 河南省招聘研究員、先進材料研究所客員教授。レーザー学会所属。
            </p>
            {/* <br/>
            <p>主な研究開発分野:</p>
              <li>高出力レーザーの産業応用</li>
      ...
      <div className={styles.companyOverview}>
        ...
        <p className={styles.content}>特許第6644342号「振動評価装置及び振動評価システム」の専用実施権</p>
        </section>
      </div>
        ...
        <div className={styles.companyOverview}>
            ...
            <p>企業の存在意義は、企業の生産するあらゆる製品やサービスなどを通して、人間社会
                ...
                追求に軸足を取った形で、収益性と成長性を高め経済発展を成し遂げてきました。
                しかし、経済発展の裏側で起こっている地球環境など社会的問題の解決は先送りとなっ
                ています。 これらの先送りされた課題に積極的に取り組む必要があると思います。 
                今や企業にとって社会的責任を無視した経営は、支持を得ることは難しいでしょう。
        ...
        <p className={styles.signature}>代表取締役 竹内清澄</p>
        </div>
    </div>
    </>
    );
